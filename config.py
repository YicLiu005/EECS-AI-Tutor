...
# Put your key here (local file). Do NOT leave it empty.
GEMINI_API_KEY: Final[str] = os.environ["GEMINI_API_KEY"] = "YOUR_API_KEY_HERE"

# REST base URL (v1beta)
GEMINI_API_BASE: Final[str] = "https://generativelanguage.googleapis.com/v1beta"

# Models
# - Use gemini-2.5-pro for generation + vision
# - Embeddings must use embedding model
GEMINI_TEXT_MODEL: Final[str] = "gemini-2.5-flash"
GEMINI_VISION_MODEL: Final[str] = "gemini-2.5-pro"
...
# Some modules may still import these older names.
